    ...
    try {
      if (isNew) {
        ...
        await putUser({
          ...
          ...formData,
          user_role: "customer",
          password: formData.password || undefined, // ถ้าเว้นว่างไม่ส่ง
        });
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5">เลขบัตรประชาชน</label>
              <input
                type="text"
                name="user_id_card"
